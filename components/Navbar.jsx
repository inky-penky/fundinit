...
const Navbar = () => {
  ...
  return (
    <div className="p-[1rem] lg:px-[5rem] lg:py-[2.5rem] flex items-center justify-between">
      ...
      <div className="flex items-center px-2 gap-3 py-1 lg:px-3 lg:gap-5 cursor-pointer text-white rounded-full bg-[#CFCFCF36] ">
        <Link href="mailto:pitch@fundinit.com" legacyBehavior>
          <a target="_blank" className="lg:text-[1.2rem]">contact</a>
        </Link>
